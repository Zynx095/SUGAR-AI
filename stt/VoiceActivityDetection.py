...
class VADDetector:
    def __init__(self, onSpeechStart, onSpeechEnd, sensitivity=0.4):
        ...
        # --- FIX 2: 2.5 SECOND SILENCE THRESHOLD ---
        ...
        # --- FIX 2b: INCREASED BUFFER ---
        # Increased to 3000 (30 seconds) so long speeches don't get chopped off
        self.voiced_frames = collections.deque(maxlen=3000)
    ...
    def audio_callback(self, indata, frames, time, status):
        ...
        if self.frameHistory[-1] == True and detection == True:
            ...
            # 100 blocks of 10ms = 1 second. 
            if self.block_since_last_spoke == int(self.pause_threshold * 100):
